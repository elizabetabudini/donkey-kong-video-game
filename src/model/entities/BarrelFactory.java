...
/**
 * 
 * A Factory Method to create different kind of Barrels (e.g different speed or
 * special features)
 *
 */
public interface BarrelFactory {
    ...
    /**
     * A method to create an {@link AbstractBarrel} with the default speed that
     * moves down each stair that it encounters.
     * 
     * @param x
     *            The starting x Coordinate.
     * @param y
