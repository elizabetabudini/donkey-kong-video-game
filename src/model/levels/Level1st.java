...
public final class Level1st extends BasicLevelImpl{ 
    ...
    //entities
    private static final Pair<Pair<Double,Double>, Pair<Integer,Integer>> MARIO = new Pair<>(new Pair<>(30.0,350.0), new Pair<>(30,25));
    ...
    private static final Pair<Pair<Double,Double>, Pair<Integer,Integer>> FLOOR_TILE_2 = new Pair<>(new Pair<>(15.0,369.0), new Pair<>(400,25));
    private static final Pair<Pair<Double,Double>, Pair<Integer,Integer>> FLOOR_TILE_3 = new Pair<>(new Pair<>(0.0,225.0), new Pair<>(400,25));
    private static final Pair<Pair<Double,Double>, Pair<Integer,Integer>> FLOOR_TILE_4 = new Pair<>(new Pair<>(15.0,81.0), new Pair<>(400,25));
